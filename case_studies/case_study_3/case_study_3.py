...
with open("../case_study_results/results_case_study_3/results_step_1.json", "w") as file:
...
with open("../case_study_results/results_case_study_3/results_step_2.json", "w") as file:
